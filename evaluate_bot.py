...
closing_longs = pd.concat([closing_longs, prices_df], axis=1, join='inner').reset_index()
shorts = pd.concat([shorts, prices_df], axis=1, join='inner').reset_index()
closing_shorts = pd.concat([closing_shorts, prices_df], axis=1, join='inner').reset_index()
